...
The Slot discipline above (and in `core/memory_rules.md`) remains the **documented fallback**: it's what governs in-session context hygiene always, and it's the only mechanism active if hooks are disabled or not installed for this project.
