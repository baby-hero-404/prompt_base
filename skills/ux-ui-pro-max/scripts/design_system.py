...
to generate comprehensive design system recommendations for UX/UI.
"""
...
from core import search, DATA_DIR, sanitize_filename
...
def generate_design_system(query: str, project_name: str = None, output_format: str = "ascii", 
    ...
    Args:
        ...
        persist: If True, save design system to docs/design-system/ folder
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    """
    Persist design system to docs/design-system/<project>/ folder using Master + Overrides pattern.
    ...
    design_system_dir = base_dir / "docs" / "design-system" / project_slug
    ...
    if page:
        page_slug = sanitize_filename(page)
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("")
    lines.append("> **LOGIC:** When building a specific page, first check `docs/design-system/pages/[page-name].md`.")
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    lines.append("")
    lines.append("> ⚠️ **IMPORTANT:** Rules in this file **override** the Master file (`docs/design-system/MASTER.md`).")
